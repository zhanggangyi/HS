...
def restart ():
    ...
    if loc != None:
        ...
        if loc !=None:
            ...
            # 五个宝箱
            # 984 351
            pyautogui.moveTo(x=984, y=351, tween=pyautogui.linear)
            pyautogui.click()
            # 754 734
            pyautogui.moveTo(x=754, y=734, tween=pyautogui.linear)
            pyautogui.click()
            # 1349 759
            pyautogui.moveTo(x=1349, y=759, tween=pyautogui.linear)
            pyautogui.click()
