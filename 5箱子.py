...
def restart ():
    ...
    if loc != None:
        ...
        if loc !=None:
            ...
            # 五个宝箱 981 325
            pyautogui.moveTo(x=981, y=325, tween=pyautogui.linear)
            pyautogui.click()
            # 1348 474
            pyautogui.moveTo(x=1348, y=474, tween=pyautogui.linear)
            pyautogui.click()
            # 1244 867
            pyautogui.moveTo(x=1244, y=867, tween=pyautogui.linear)
            pyautogui.click()
            # 795 794
            pyautogui.moveTo(x=795, y=794, tween=pyautogui.linear)
            pyautogui.click()
            # 677 444
            pyautogui.moveTo(x=677, y=444, tween=pyautogui.linear)
            pyautogui.click()
...
def round():
    ...
    while(count != TOTAL_ROUND):
        ...
        if(loc != None):#战斗
            count = count + 1
            pyautogui.moveTo(x=1494, y=829, duration=1, tween=pyautogui.linear)
            pyautogui.click()
            battle()
        ...
        pyautogui.moveTo(x=100, y=100, tween=pyautogui.linear)
        pyautogui.click()
        wait_until('chakanduiwu.png',mode = 0)
        time.sleep(1)
